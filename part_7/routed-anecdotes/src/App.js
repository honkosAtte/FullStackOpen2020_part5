...
const App = () => {
  ...
  const anecdote = match ? anecdoteById(match.params.id.toString()) : null
  //console.log('matsi', match.params.id) //Hahaa, tässähän vertaillaan stringejä! 
  ...
  return (
    <div>
      ...
      <Route path='/:id'>
        <Anecdote anecdote={anecdote} setNotification={setNotification}/>
        </Route>
      <Route path='/'>
